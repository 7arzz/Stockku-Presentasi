    ...
    <div class="col-md-8 col-lg-5">
        <div class="glass-card p-5">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Buat akun karyawan baru</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <label class="form-label text-muted">Ulangi Password</label>
                        <input type="password" name="password_confirmation" class="form-control" required>
                    </div>
                </div>

                <div class="mb-4">
                    <label class="form-label text-muted">Daftar Sebagai (Role)</label>
